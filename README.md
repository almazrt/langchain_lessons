...
3. [Урок 3: Работа с внешними данными и индексами](lessons/lesson3.md) - работа с документами, загрузчиками, векторными хранилищами
4. [Урок 4: Работа с агентами](lessons/lesson4.md) - создание автономных агентов, работа с инструментами
5. [Урок 5: Продвинутые техники и лучшие практики](lessons/lesson5.md) - асинхронное программирование, обработка ошибок, кэширование, мониторинг
